...
export function RecoveryTrendCard() {
  return (
    <div className="flex h-full flex-col rounded-2xl border border-emerald-500/15 bg-emerald-500/8 px-4 py-4">
      ...
      <div className="mt-1 flex justify-between text-[10px] font-semibold uppercase tracking-wide text-gray-500">
        <span>Today</span>
        <span>8 Weeks</span>
        <span>16 Weeks</span>
      </div>
      <p className="mt-3 flex items-center gap-1.5 text-[11px] font-medium text-gray-400">
