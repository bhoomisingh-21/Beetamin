    ...
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="border-b border-emerald-100 bg-emerald-50/60 px-6 py-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Personal details and body metrics for {clientName}</p>
            </div>
          </div>
        </div>
      ...
      <div className={`${portal.card} overflow-hidden`}>
        <div className="border-b border-emerald-100 bg-emerald-50/60 px-6 py-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-black text-slate-900">Health &amp; Diet</h3>
              <p className="text-xs text-slate-500">Activity, preferences and clinical information</p>
            </div>
          </div>
        </div>
        <div className="grid gap-5 p-6 sm:grid-cols-2">
      ...
      <div className="flex justify-center pb-4">
        <button
          type="submit"
          disabled={saving}
          className="inline-flex min-w-[200px] items-center justify-center gap-2 rounded-full bg-emerald-600 px-8 py-3.5 text-sm font-bold text-white shadow-sm transition hover:bg-emerald-500 disabled:opacity-50"
        >
