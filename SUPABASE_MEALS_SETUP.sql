-- ============================================================
-- TheBeetamin — Tagged Indian meal database (rule-based meal engine)
-- Run ONCE in Supabase Dashboard → SQL Editor → New query → Run
-- Mirrors supabase/migrations/20260802120000_create_meals_table.sql
-- Adds: public.meals table + indexes + RLS (read-only for anon/authenticated)
-- Populate afterward with: npx tsx scripts/seed-meal-database.ts
-- ============================================================
