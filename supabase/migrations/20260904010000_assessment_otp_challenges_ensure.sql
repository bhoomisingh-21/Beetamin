-- Idempotent: creates the assessment OTP table + lead snapshot columns if missing,
-- then asks PostgREST to reload its schema cache (PGRST204/PGRST205).
...
grant all on table public.assessment_otp_challenges to service_role;
