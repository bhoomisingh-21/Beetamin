...
/** Label for dashboard report rows — date + clock time so multiple reports on same day stay distinct. */
...
type SessionsPageClientProps = { initialDashboard: ClientSessionsDashboard }

export default function SessionsPageClient({ initialDashboard }: SessionsPageClientProps) {
