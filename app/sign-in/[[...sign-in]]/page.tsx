              ...
              <div className="clerk-sign-in-wrapper w-full">
                <SignIn
                  ...
                  appearance={{
                    ...
                    header: 'hidden',
                    socialButtonsBlockButton: 'border border-gray-200 rounded-xl h-11 font-medium text-sm text-gray-700 hover:bg-gray-50 transition mb-3',
                    socialButtonsBlockButtonText: 'font-medium',
                    dividerRow: 'my-4',
                    dividerText: 'text-gray-400 text-xs',
                    formFieldLabel: 'text-gray-700 text-sm font-medium',
                    formFieldInput: 'border border-gray-200 rounded-xl px-4 h-11 text-gray-900 text-sm focus:border-emerald-500 focus:ring-emerald-100 focus:ring-2 focus:outline-none',
                    ...
                    otpCodeFieldInput: 'border border-gray-200 rounded-xl text-gray-900 font-bold text-lg text-center focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 focus:outline-none',
